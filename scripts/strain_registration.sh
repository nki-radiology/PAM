...
# Run your command
python /home/s.trebeschi/PAM/train.py --batch-size 12 --registration-only True --wandb registration-only --body-part thorax --filters "16,32,64,128,256,512,1024,1024" --filters-discriminator "16,32,64,128,256,512,1024,1024"