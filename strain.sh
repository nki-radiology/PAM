#!/bin/bash
#SBATCH --time=14-00:00:00                           # Time limit hrs:min:sec
#SBATCH --job-name=prj-blue                         # Job name
...
#SBATCH --output=/home/s.trebeschi/PAM/log/slurm_%j.log # Standard output and error log
pwd; hostname; date
