...
if __name__ == '__main__':
    ...
    parser.add_argument('--filters',    default=[16, 32, 64, 128], type=object,  help='filters to create the Beta-VAE')
    ...
    parser.add_argument('--lambda_value_wae',default=10,     type=float,     help='lambda parameter for the WAE loss')
