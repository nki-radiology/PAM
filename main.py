...
if __name__ == '__main__':
    ...
    parser.add_argument('--model',      default='WAE', type=str,       help='Wasserstein Autoencoder (WAE) and Beta Variational Autoencoder (Beta-VAE)')
    ...
    parser.add_argument('--lambda_value',default=10,     type=float,     help='lambda parameter for the reconstruction loss')
    parser.add_argument('--sigma_value', default=1.0,         type=float,     help='sigma parameter for the WAE method')
    ...
    parser.add_argument('--ckpt_dir',   default='/projects/disentanglement_methods/checkpoints/WAE/adversarial/',  type=str, help='checkpoint directory')
    parser.add_argument('--results_dir',default='/projects/disentanglement_methods/results/WAE/adversarial/',      type=str, help='Results directory of the weight&biases images')
