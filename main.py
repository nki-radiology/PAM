...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dim',   default=[192, 192, 160], type=int,  help='dimension of the data')
    ...
    parser.add_argument('--filters',     default=[32, 64, 128, 256, 512],         type=object,  help='filters to create the Affine and Deformation networks')
    parser.add_argument('--filters_disc',default=[8, 16, 32, 64, 128, 256, 512], type=object,  help='filters to create the Discriminator network')
    parser.add_argument('--train_split', default=0.8,       type=float,     help='percentage to split the dataset for training')
    
    parser.add_argument('--alpha_value', default=0.01,      type=float,     help='beta parameter for the affine penalty loss')
    parser.add_argument('--beta_value',  default=0.01,      type=float,     help='beta parameter for the deformation penalty loss')
    parser.add_argument('--gamma_value', default=0.1,       type=float,     help='gamma parameter for the discriminator (feature matching loss: MSE)')
