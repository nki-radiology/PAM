...
from   networks_v4.layers           import *
from   networks_v4.SpatialTransform import SpatialTransform
...
class AffineNetwork(nn.Module):
    ...
    def __init__(self,
        ...
        # self.conv_final = get_conv_layer(num_filters_out, num_filters_out, kernel_size=1, stride=1, padding=0,
        #                                 bias=True, dim=self.dim)
