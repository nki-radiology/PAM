...
#SBATCH --job-name=AdvBVAE                          # Job name
...
#SBATCH --output=/projects/disentanglement_methods/outputjobs/Beta_VAE/adversarial/slurm_%j.log   # Standard output and error log
pwd; hostname; date
